...
- (void)testInitWithNameType {
    FileModel *file = [[FileModel alloc]initWithNameType:_fileName fileType:_fileType];
...
- (void)testFileModelSimpleConvenienceInitializer {
    FileModel *file = [FileModel fileModelWithNameType:_fileName fileType:_fileType];
...
- (void)testInitWithNameAndAll {
    FileModel *file = [[FileModel alloc]initWithNameAndAll:_fileName isFolder:_isFolder modDate:_modDate fileType:_fileType isOrange:_isOrange isBlue:_isBlue];
...
- (void)testFileModelComplexConvenienceInitializer {
    FileModel *file = [FileModel fileModelWithNameAndEverything:_fileName isFolder:_isFolder modDate:_modDate fileType:_fileType isOrange:_isOrange isBlue:_isBlue];
...
- (void) testEncodeWithCoder {
    ...
    [[mockCoder expect] encodeObject:_fileName  forKey:@"fileName"];
    [[mockCoder expect] encodeBool:_isFolder    forKey:@"isFolder"];
    [[mockCoder expect] encodeObject:_modDate   forKey:@"modDate"];
    [[mockCoder expect] encodeInteger:_fileType forKey:@"fileType"];
    [[mockCoder expect] encodeBool:_isOrange    forKey:@"isOrange"];
    [[mockCoder expect] encodeBool:_isBlue      forKey:@"isBlue"];
...
- (void)testNSCopying {
    FileModel *fileOrig = [FileModel fileModelWithNameAndEverything:_fileName isFolder:_isFolder modDate:_modDate fileType:_fileType isOrange:_isOrange isBlue:_isBlue];
